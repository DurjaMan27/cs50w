# Generated by Django 4.2.6 on 2024-02-03 21:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('General', 'General'), ('Fashion', 'Fashion'), ('Toys', 'Toys'), ('Electronics', 'Electronics'), ('Home', 'Home')], max_length=15)),
                ('image', models.URLField(blank=True)),
                ('currentBid', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='currentBid', to='auctions.bid')),
